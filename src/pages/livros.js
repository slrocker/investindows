        ...
        <Layout>
            ...
            <div className={livrosStyles.content}>
               ...
               <div className={livrosStyles.book}>
                   <img className={livrosStyles.featuredImage} src={capaMercadoFinanceiroImg}></img>
               ...
               <div className={livrosStyles.book}>
                   <img className={livrosStyles.featuredImage} src={capaAcoesImg}></img>
               ...
               <div className={livrosStyles.book}>
                   <img className={livrosStyles.featuredImage} src={capaFIIImg}></img>
               ...
               <div className={livrosStyles.book}>
                   <img className={livrosStyles.featuredImage} src={capaTesouroDiretoImg}></img>
                   <h3 className={livrosStyles.bookTitle}><Link to="/livros/aprenda-a-investir-no-tesouro-direto">Aprenda a Investir no Teosuro Direto.</Link></h3>
