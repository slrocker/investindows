...
Atualmente, os bancos expandiram a sua área de atuação, oferecendo também serviços como:
...
Essa situação se assemelha a, por exemplo, você pedir para algum amigo guardar o seu carro durante o fim de semana e ele, em vez de guardá-lo, alugá-lo a terceiros.
...
Emprestando valores que possui em depósitos à vista, o banco consegue colocar mais dinheiro em circulação do que existia anteriormente. Por isso, diz-se que os bancos são **instituições financeiras monetárias**, ou seja, capazes de multiplicar a moeda.
...
Quando os empréstimos e investimentos de um banco dão errado e ele não tem mais como honrar seus compromissos, ele fica insolvente e declara falência. Quando um banco declara falência, seus credores - nos quais você, como correntista, se inclui - ficam a ver navios. Em resumo, você perdeu os R$100,00 que possuia depositados no banco.
